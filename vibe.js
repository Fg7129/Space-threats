...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function createPlayer(){ return { x: W/2, y: H-80, w: 40, h: 26, speed: 4.2, health: 100, color1:'#2ec4b6', color2:'#1b9aaa' }; }
  ...
  function createBoss(){ return { x: W/2, y: 120, r:80, hp: 1200, maxHp:1200, vx:1.2, color:'#b23cff' }; }
